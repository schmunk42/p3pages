...
abstract class BaseP3PageTranslation extends CActiveRecord{
	...
	public function rules()
	{
		return array(
			...
			array('language, seoUrl, pageTitle, keywords, description', 'default', 'setOnEmpty' => true, 'value' => null),
			...
			array('id, p3_page_id, language, seoUrl, pageTitle, menuName, keywords, description', 'safe', 'on'=>'search'),
		);
	}
