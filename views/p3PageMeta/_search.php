    ...
    <?php $form=$this->beginWidget('CActiveForm', array(
        ...
        'method'=>'get',
            ...
            <?php echo $form->label($model,'id'); ?>
                            <?php echo $form->dropDownList($model,'id',CHtml::listData(P3Page::model()->findAll(), 'id', 'layout'),array('prompt'=>'all')); ?>
                    </div>
            ...
            <?php echo $form->label($model,'treeParent_id'); ?>
                            <?php echo $form->dropDownList($model,'treeParent_id',CHtml::listData(P3PageMeta::model()->findAll(), 'id', 'status'),array('prompt'=>'all')); ?>
                    </div>
