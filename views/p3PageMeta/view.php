...
<h1>
    P3 Page Meta <small>View #<?php echo $model->id ?></small></h1>
...
<div class='span3'><?php $this->widget('bootstrap.widgets.TbButtonGroup', array(
        ...
        'buttons'=>array(
            array('label'=>'p3PageMetas', 'icon'=>'icon-list-alt', 'url'=> array('p3PageMeta/admin')),
                array('icon'=>'icon-plus', 'url'=>array('p3PageMeta/create', 'P3PageMeta' => array('treeParent_id'=>$model->{$model->tableSchema->primaryKey}))),
        ),
    )); ?></div><div class='span8'>
<?php
    ...
    if (is_array($model->p3PageMetas)) {
        ...
        echo CHtml::openTag('ul');
            foreach($model->p3PageMetas as $relatedModel) {
                ...
                echo '<li>';
                echo CHtml::link($relatedModel->status, array('p3PageMeta/view','id'=>$relatedModel->id), array('class'=>''));
