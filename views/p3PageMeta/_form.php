<div class="form">
    <p class="note">
        <?php echo Yii::t('P3PagesModule.crud','Fields with');?> <span class="required">*</span> <?php echo Yii::t('P3PagesModule.crud','are required');?>        .
    </p>
...
<?php if('help.status' != $help = Yii::t('P3PagesModule.crud', 'help.status')) { 
...
<?php if('help.type' != $help = Yii::t('P3PagesModule.crud', 'help.type')) { 
    echo "<span class='help-block'>$help</span>";
} ?></div>
...
<?php if('help.treePosition' != $help = Yii::t('P3PagesModule.crud', 'help.treePosition')) { 
    echo "<span class='help-block'>$help</span>";
} ?></div>
...
<?php if('help.begin' != $help = Yii::t('P3PagesModule.crud', 'help.begin')) { 
    echo "<span class='help-block'>$help</span>";
} ?></div>
...
<?php if('help.end' != $help = Yii::t('P3PagesModule.crud', 'help.end')) { 
    echo "<span class='help-block'>$help</span>";
} ?></div>
...
<?php if('help.customData' != $help = Yii::t('P3PagesModule.crud', 'help.customData')) { 
    echo "<span class='help-block'>$help</span>";
} ?></div>
...
<?php if('help.label' != $help = Yii::t('P3PagesModule.crud', 'help.label')) { 
    echo "<span class='help-block'>$help</span>";
} ?></div>
...
<?php if('help.owner' != $help = Yii::t('P3PagesModule.crud', 'help.owner')) { 
    echo "<span class='help-block'>$help</span>";
} ?></div>
...
<?php if('help.checkAccessCreate' != $help = Yii::t('P3PagesModule.crud', 'help.checkAccessCreate')) { 
    echo "<span class='help-block'>$help</span>";
} ?></div>
...
<?php if('help.checkAccessRead' != $help = Yii::t('P3PagesModule.crud', 'help.checkAccessRead')) { 
    echo "<span class='help-block'>$help</span>";
} ?></div>
...
<?php if('help.checkAccessUpdate' != $help = Yii::t('P3PagesModule.crud', 'help.checkAccessUpdate')) { 
    echo "<span class='help-block'>$help</span>";
} ?></div>
...
<?php if('help.checkAccessDelete' != $help = Yii::t('P3PagesModule.crud', 'help.checkAccessDelete')) { 
    echo "<span class='help-block'>$help</span>";
} ?></div>
...
<?php if('help.createdAt' != $help = Yii::t('P3PagesModule.crud', 'help.createdAt')) { 
    echo "<span class='help-block'>$help</span>";
} ?></div>
...
<?php if('help.createdBy' != $help = Yii::t('P3PagesModule.crud', 'help.createdBy')) { 
    echo "<span class='help-block'>$help</span>";
} ?></div>
...
<?php if('help.modifiedAt' != $help = Yii::t('P3PagesModule.crud', 'help.modifiedAt')) { 
    echo "<span class='help-block'>$help</span>";
} ?></div>
...
<?php if('help.modifiedBy' != $help = Yii::t('P3PagesModule.crud', 'help.modifiedBy')) { 
    echo "<span class='help-block'>$help</span>";
} ?></div>
...
<?php if('help.guid' != $help = Yii::t('P3PagesModule.crud', 'help.guid')) { 
    echo "<span class='help-block'>$help</span>";
} ?></div>
...
<?php if('help.ancestor_guid' != $help = Yii::t('P3PagesModule.crud', 'help.ancestor_guid')) { 
    echo "<span class='help-block'>$help</span>";
} ?></div>
...
<?php if('help.model' != $help = Yii::t('P3PagesModule.crud', 'help.model')) { 
    echo "<span class='help-block'>$help</span>";
} ?></div>
