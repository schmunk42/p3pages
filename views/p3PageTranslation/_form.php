...
<div class='hint'><?php if('hint.P3PageTranslation.properties' != $hint = Yii::t('app', 'properties')) echo $hint; ?></div>
</div>
...
<div class='hint'><?php if('hint.P3PageTranslation.content' != $hint = Yii::t('app', 'content')) echo $hint; ?></div>
</div>
