    ...
    <div class="btn-toolbar pull-right">
        ...
        <?php if($this->action->id == 'admin' || $this->action->id == 'view'): ?>                    <div class="btn-group">
                ...
                <?php endif; ?>                <?php $this->widget('bootstrap.widgets.TbButtonGroup', array(
                       'buttons' => array(
                               array('label'=>Yii::t('crud','Relations'), 'icon'=>'icon-random', 'items'=>array(array('icon' => 'circle-arrow-left','label' => Yii::t('P3MediaModule.model','P3Page'), 'url' =>array('/p3pages/p3Page/admin')),
            )
          ),
        ),
    ));
        ...
        <div class="btn-group">
            <?php
             $this->widget("bootstrap.widgets.TbButton", array(
                           ...
                           "icon"=>"icon-list-alt",
                           "url"=>array("admin"),
                           "visible"=>$showManageButton && Yii::app()->user->checkAccess("P3pages.P3PageTranslation.View")
                        ));
         ?>        </div>
    </div>
            ...
            <?php
                   ...
                   $this->widget("bootstrap.widgets.TbButton", array(
                    ...
                    $this->widget("bootstrap.widgets.TbButton", array(
                       ...
                       "visible"=>$showSaveButton && Yii::app()->user->checkAccess("P3pages.P3PageTranslation.View")
                    ));
             ?>        </div>
    </div>
