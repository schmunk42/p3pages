...
<?php ?>                                    <?php echo '<h3>A) Title, Layout & View</h3>' ?>
<div class="control-group">
    <div class='control-label'>
...
<?php ?>                                    <?php echo '<h3>B) Weiterleitung</h3>' ?>
<div class="control-group">
    <div class='control-label'>
...
<div class="control-group">
    ...
    <div class='controls'>
        <div style="display: inline-block" data-toggle='tooltip' data-placement="right"
             title='<?php echo (($t = Yii::t('P3PagesModule.model', 'tooltip.access_read')) != 'tooltip.access_read') ?
                 $t : '' ?>'>
            <?php
...
<div class="control-group">
    ...
    <div class='controls'>
        <div style="display: inline-block" data-toggle='tooltip' data-placement="right"
             title='<?php echo (($t = Yii::t('P3PagesModule.model', 'tooltip.created_at')) != 'tooltip.created_at') ?
                 $t : '' ?>'>
            <?php
...
<div class="control-group">
    ...
    <div class='controls'>
        <div style="display: inline-block" data-toggle='tooltip' data-placement="right"
             title='<?php echo (($t = Yii::t('P3PagesModule.model', 'tooltip.updated_at')) != 'tooltip.updated_at') ?
                 $t : '' ?>'>
            <?php
